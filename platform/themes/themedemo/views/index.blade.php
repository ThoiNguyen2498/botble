<section class="hero-equal-height pt-165 pb-100 gradient-overly-right-light" style="background: url('{!! Theme::asset()->url('img/hero-bg4.jpg') !!}')no-repeat center center / cover">
    {!! do_shortcode('[hero-section][/hero-section]') !!}
</section>
...
<section class="about-us-section pb-100">
    {!! do_shortcode('[about-us-section][/about-us-section]') !!}
</section>
	    ...
	    <div class="row justify-content-center">
	        <div class="col-md-9 col-lg-8">
	            <div class="app-business-content text-center text-white">
	                ...
	                {!! do_shortcode('[promo-section2][/promo-section2]') !!}
	            </div>
	        </div>
	    </div>
	</div>
...
<section class="our-portfolio-section ptb-100">
	<div class="container">
	    ...
	    {!! do_shortcode('[our-portfolio-section][/our-portfolio-section]') !!}
	</div>
...
<section class="our-blog-section ptb-100 gray-light-bg">
    <div class="container">
        ...
        {!! do_shortcode('[blog-section][/blog-section]') !!}
    </div>
</section>
<!--blog section end-->
...
<section class="testimonial-section ptb-100">
    <div class="container">
        ...
        {!! do_shortcode('[testimonial-section][/testimonial-section]') !!}
...
<section class="team-two-section ptb-100 gray-light-bg">
    <div class="container">
        ...
        {!! do_shortcode('[team-two-section][/team-two-section]') !!}
    </div>
</section>
<!--team two section end-->


{!! do_shortcode('[call-to-action][/call-to-action]') !!}